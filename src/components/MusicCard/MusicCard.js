...
import {Card, CardActions,CardActionArea,CardContent,Typography}  from '@material-ui/core';
    ...
    return (
        <Card  className={classes.activeCard}>
            <CardActionArea  target="_blank">
                ...
                <Typography className={classes.title} gutterBottom variant="h6"></Typography>
                <CardContent>
